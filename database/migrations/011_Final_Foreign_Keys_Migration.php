...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('asset_categories', function (Blueprint $table) {
            $table->foreign('parent_category_id')->references('id')->on('asset_categories')->onDelete('set null');
        });
        ...
        Schema::table('assets', function (Blueprint $table) {
            ...
            $table->foreign('centre_id')->references('centre_id')->on('centres')->onDelete('cascade');
            $table->foreign('current_location_id')->references('id')->on('asset_locations')->onDelete('set null');
        ...
        Schema::table('letters', function (Blueprint $table) {
            ...
            $table->foreign('recipient_trainee_id')->references('id')->on('trainees')->onDelete('set null');
    ...
    public function down(): void
    {
        ...
        Schema::table('letters', function (Blueprint $table) {
            $table->dropForeign(['template_id', 'recipient_trainee_id', 'recipient_user_id', 'generated_by', 'centre_id']);
        });
        ...
        Schema::table('assets', function (Blueprint $table) {
            $table->dropForeign(['asset_type_id', 'asset_category_id', 'centre_id', 'current_location_id', 'assigned_to_user_id']);
        });
        ...
        Schema::table('staff_attendances', function (Blueprint $table) {
            $table->dropForeign(['user_id', 'centre_id', 'approved_by', 'marked_by_user_id']);
        });

        Schema::table('activity_enrollments', function (Blueprint $table) {
            $table->dropForeign(['activity_id', 'trainee_id', 'enrolled_by']);
        });
