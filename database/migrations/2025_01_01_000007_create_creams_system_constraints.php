...
class CreateCreamsSystemConstraints extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('contact_messages', function (Blueprint $table) {
            $table->foreign('centre_id')->references('centre_id')->on('centres')->onDelete('set null');
            $table->foreign('replied_by')->references('id')->on('staffs')->onDelete('set null');
        });

        // 3. SERVICE DELIVERY CONSTRAINTS
        Schema::table('activities', function (Blueprint $table) {
            // category_id removed - now using string enum column instead of FK
            $table->foreign('centre_id')->references('centre_id')->on('centres')->onDelete('cascade');
            $table->foreign('instructor_id')->references('id')->on('staffs')->onDelete('set null');
        });
        ...
        Schema::table('staff_attendances', function (Blueprint $table) {
            ...
            $table->foreign('centre_id')->references('centre_id')->on('centres')->onDelete('set null');
            $table->foreign('marked_by_user_id')->references('id')->on('staffs')->onDelete('set null');
        ...
        Schema::table('trainee_attendances', function (Blueprint $table) {
            ...
            $table->foreign('session_id')->references('id')->on('activity_occurrences')->onDelete('set null');
            $table->foreign('marked_by_user_id')->references('id')->on('staffs')->onDelete('set null');
        });

        Schema::table('session_attendance', function (Blueprint $table) {
            $table->foreign('session_id')->references('id')->on('activity_occurrences')->onDelete('cascade');
            $table->foreign('trainee_id')->references('id')->on('trainees')->onDelete('cascade');
            $table->foreign('marked_by')->references('id')->on('staffs')->onDelete('set null');
        });

        Schema::table('attendance_alerts', function (Blueprint $table) {
            $table->foreign('user_id')->references('id')->on('staffs')->onDelete('cascade');
            $table->foreign('trainee_id')->references('id')->on('trainees')->onDelete('cascade');
            $table->foreign('resolved_by')->references('id')->on('staffs')->onDelete('set null');
        });
        ...
        Schema::table('asset_movements', function (Blueprint $table) {
            ...
            $table->foreign('moved_by_user_id')->references('id')->on('staffs')->onDelete('cascade');
        });
        ...
        Schema::table('message_recipients', function (Blueprint $table) {
            ...
            $table->foreign('recipient_id')->references('id')->on('staffs')->onDelete('cascade');
        });

        Schema::table('letters', function (Blueprint $table) {
            $table->foreign('created_by')->references('id')->on('staffs')->onDelete('cascade');
            $table->foreign('generated_by')->references('id')->on('staffs')->onDelete('set null');
    ...
    public function down(): void
    {
        ...
        Schema::table('activities', function (Blueprint $table) {
            $table->dropForeign(['centre_id', 'instructor_id']); // category_id removed
        });
