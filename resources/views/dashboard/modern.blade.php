                    ...
                    <div class="header-actions">
                        ...
                        <div class="action-buttons">
                            ...
                            <div class="dropdown d-inline-block">
                                <button class="btn btn-icon" type="button" onclick="openQuickSettings()" title="Settings">
...
function markAllRead() {
    console.log('markAllRead function called');
    
    // Hide the entire Important Updates section
    const notificationsBar = document.querySelector('.unified-notifications-bar');
    if (notificationsBar) {
        console.log('Hiding notifications bar');
        // Add smooth transition
        notificationsBar.style.transition = 'all 0.5s ease-out';
        notificationsBar.style.opacity = '0';
        notificationsBar.style.transform = 'translateY(-20px)';
        notificationsBar.style.marginBottom = '0';
        
        // After animation, completely hide the element
        setTimeout(() => {
            notificationsBar.style.display = 'none';
            console.log('Notifications bar hidden');
        }, 500);
    }
    
    // Mark individual notifications as read (fade them)
    ...
    alert('✅ All notifications marked as read!\n\nThe Important Updates section has been dismissed.');
}
