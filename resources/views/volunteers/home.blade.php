            ...
            <div class="col-lg-10">
                <div class="stats-wrapper">
                    <div class="text-center mb-4">
                        <h3 class="mb-2">Building Our Volunteer Community</h3>
                        <p class="text-muted">As a new centre, we're actively growing our volunteer network to serve children with disabilities in our community.</p>
                    </div>
                    <div class="row text-center">
                        <div class="col-md-3 col-6" data-aos="fade-up" data-aos-delay="100">
                            <div class="stat-item">
                                ...
                                <div class="stat-text">Growing</div>
                                <div class="stat-label">Children Program</div>
                            </div>
                        </div>
                        <div class="col-md-3 col-6" data-aos="fade-up" data-aos-delay="200">
                            <div class="stat-item">
                                ...
                                <div class="stat-text">Recruiting</div>
                                <div class="stat-label">Volunteer Team</div>
                            </div>
                        </div>
                        <div class="col-md-3 col-6" data-aos="fade-up" data-aos-delay="300">
                            <div class="stat-item">
                                ...
                                <div class="stat-text">Planning</div>
                                <div class="stat-label">Program Sessions</div>
                            </div>
                        </div>
                        <div class="col-md-3 col-6" data-aos="fade-up" data-aos-delay="400">
                            <div class="stat-item">
                                ...
                                <div class="stat-text">Ready</div>
                                <div class="stat-label">To Make Impact</div>
                            </div>
                        </div>
                    </div>
                    <div class="text-center mt-4">
                        <p class="small text-muted"><i class="fas fa-info-circle"></i> Join us in building something meaningful for children with special needs</p>
                    </div>
                </div>
            </div>
        </div>
