                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="asset_id" name="asset_id"
                                    placeholder="e.g., AST-2024-001" value="{{ old('asset_id') }}" required>
                                <div class="form-text">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="asset_name" name="asset_name"
                                    placeholder="e.g., Dell Laptop Inspiron 15" value="{{ old('asset_name') }}" required>
                                <div class="form-text">
                                    <i class="fas fa-info-circle"></i>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="asset_parent" name="asset_parent" required>
                                    <option value="">Select Asset Type</option>
                                    <option value="Computer" {{ old('asset_parent') == 'Computer' ? 'selected' : '' }}>
                                        Computer</option>
                                    <option value="Furniture" {{ old('asset_parent') == 'Furniture' ? 'selected' : '' }}>
                                        Furniture</option>
                                    <option value="Equipment" {{ old('asset_parent') == 'Equipment' ? 'selected' : '' }}>
                                        Equipment</option>
                                    <option value="Vehicle" {{ old('asset_parent') == 'Vehicle' ? 'selected' : '' }}>Vehicle
                                    </option>
                                    <option value="Books" {{ old('asset_parent') == 'Books' ? 'selected' : '' }}>Books
                                    </option>
                                    <option value="Medical" {{ old('asset_parent') == 'Medical' ? 'selected' : '' }}>
                                        Medical Equipment</option>
                                    <option value="Sports" {{ old('asset_parent') == 'Sports' ? 'selected' : '' }}>Sports
                                        Equipment</option>
                                    <option value="Other" {{ old('asset_parent') == 'Other' ? 'selected' : '' }}>Other
                                    </option>
                                </select>
                                <div class="form-text">
                                    <i class="fas fa-info-circle"></i>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="asset_brand" name="asset_brand"
                                    placeholder="e.g., Dell, HP, Samsung" value="{{ old('asset_brand') }}">
                                <div class="form-text">
                                    <i class="fas fa-info-circle"></i>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="asset_quantity" name="asset_quantity"
                                    placeholder="1" min="0" value="{{ old('asset_quantity', 1) }}" required>
                                <div class="form-text">
                                    <i class="fas fa-info-circle"></i>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" id="asset_price" name="asset_price"
                                        ...
                                        value="{{ old('asset_price') }}" required>
                                </div>
                                <div class="form-text">
                                    <i class="fas fa-info-circle"></i>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">RM</span>
                                    <input type="text" class="form-control" id="total_value" readonly value="0.00">
                                </div>
                                <div class="form-text">
                                    <i class="fas fa-info-circle"></i>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="centre_name" name="centre_name" required>
                                    ...
                                    @if (isset($centres))
                                        ...
                                        @endforeach
                                    @else
                                        <option value="Gombak" {{ old('centre_name') == 'Gombak' ? 'selected' : '' }}>
                                            Gombak</option>
                                        <option value="Kuantan" {{ old('centre_name') == 'Kuantan' ? 'selected' : '' }}>
                                            Kuantan</option>
                                    @endif
                                </select>
                                <div class="form-text">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="asset_note" name="asset_note" rows="4"
