                        ...
                        <tbody>
                            @foreach($assets as $asset)
                                <tr>
                                    ...
                                    <td>
                                        <span class="quantity-badge {{ $asset->asset_quantity <= 5 ? 'quantity-low' : ($asset->asset_quantity <= 10 ? 'quantity-medium' : 'quantity-high') }}">
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            <a href="{{ route('assets.show', $asset->asset_id) }}" class="btn btn-sm btn-outline-primary" title="View Details">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            @if(in_array(session('role'), ['admin', 'supervisor']))
                                                <a href="{{ route('assets.edit', $asset->asset_id) }}" class="btn btn-sm btn-outline-warning" title="Edit Asset">
