    ...
    <div class="asset-overview">
        ...
        <div class="asset-profile">
            ...
            <div class="asset-info-section">
                ...
                <div class="asset-type-badge">{{ $asset->asset_type ?? 'N/A' }}</div>
                ...
                <div class="asset-meta">
                    ...
                    <div class="meta-item">
                        ...
                        <div class="meta-value price-display">RM {{ number_format(($asset->asset_quantity ?? 0) * ($asset->asset_price ?? 0), 2) }}</div>
                    </div>
                    <div class="meta-item">
        ...
        <div class="detail-card">
            ...
            <div class="detail-card-body">
                ...
                <div class="detail-item">
                    ...
                    <span class="detail-value">RM {{ number_format(($asset->asset_quantity ?? 0) * ($asset->asset_price ?? 0), 2) }}</span>
                </div>
                <div class="detail-item">
        ...
        <div class="detail-card">
            ...
            <div class="detail-card-body">
                <div class="timeline">
                    ...
                    @endif
                    <div class="timeline-item">
                        <div class="timeline-date">{{ $asset->created_at ? $asset->created_at->format('M j, Y g:i A') : 'N/A' }}</div>
