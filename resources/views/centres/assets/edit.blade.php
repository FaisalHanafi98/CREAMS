...
<div class="container-fluid">
    ...
    <!-- Asset Edit Form -->
    <form action="{{ route('centres.assets.update', $asset->asset_id) }}" method="POST" enctype="multipart/form-data" id="assetForm">
        @csrf
        @method('PUT')
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control editable-field" id="asset_type" name="asset_type" disabled required>
                                ...
                                <option value="Books" {{ old('asset_type', $asset->asset_type) == 'Books' ? 'selected' : '' }}>Books</option>
                                <option value="Medical" {{ old('asset_type', $asset->asset_type) == 'Medical' ? 'selected' : '' }}>Medical Equipment</option>
                                <option value="Sports" {{ old('asset_type', $asset->asset_type) == 'Sports' ? 'selected' : '' }}>Sports Equipment</option>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('asset_brand', $asset->asset_brand) }}" 
                                   readonly>
                            <div class="form-text">
                                <i class="fas fa-info-circle"></i>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" 
                                   ...
                                   placeholder="1" 
                                   min="0" 
                                   value="{{ old('asset_quantity', $asset->asset_quantity) }}" 
                                   readonly 
                                   required>
                            <div class="form-text">
                                <i class="fas fa-info-circle"></i>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <select class="form-control editable-field" id="centre_name" name="centre_name" disabled required>
                                ...
                                @if(isset($centres))
                                    ...
                                    @endforeach
                                @else
                                    <option value="Gombak" {{ old('centre_name', $asset->centre_name ?? $asset->center_name) == 'Gombak' ? 'selected' : '' }}>Gombak</option>
                                    <option value="Kuantan" {{ old('centre_name', $asset->centre_name ?? $asset->center_name) == 'Kuantan' ? 'selected' : '' }}>Kuantan</option>
                                @endif
                            </select>
                            <div class="form-text">
                                <i class="fas fa-info-circle"></i>
        ...
        <div class="form-card">
            ...
            <div class="form-body">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control editable-field" 
                                      ...
                                      name="asset_note" 
                                      rows="4" 
                                      placeholder="Additional notes, specifications, or important details about this asset..." 
                                      readonly>{{ old('asset_note', $asset->asset_note) }}</textarea>
                            <div class="form-text">
                                <i class="fas fa-info-circle"></i>
                ...
                <div class="form-group">
                    ...
                    <div class="image-upload-container" onclick="document.getElementById('asset_avatar').click()" style="pointer-events: none;">
