                ...
                <div class="action-group">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{ route('centres.attendance.index') }}?centre={{ $centre->centre_id }}">
                ...
                <div class="stat-card stat-success">
                    ...
                    <div class="stat-content">
                        ...
                        <div class="stat-detail">
                            ...
                            <span>{{ number_format(($stats->total_trainees ?? 0) / max($centre->centre_capacity ?? 1, 1) * 100, 1) }}% capacity</span>
                        </div>
                    </div>
                    <div class="stat-trend">
                        <i class="fas fa-arrow-up text-success"></i>
        ...
        <div class="left-column">
            ...
            <div class="info-card">
                <div class="card-header">
                    ...
                    <span class="last-updated">Updated {{ $centre->updated_at ? $centre->updated_at->diffForHumans() : 'recently' }}</span>
                </div>
                                ...
                                <div class="detail-item">
                                    ...
                                    <span class="capacity-display">
                                        ...
                                        @if($centre->centre_capacity)
                                            <small>({{ number_format(($stats->total_trainees ?? 0) / $centre->centre_capacity * 100, 1) }}% utilized)</small>
                                        @endif
                                    </span>
                                </div>
                            </div>
                        ...
                        <div class="detail-section">
                            ...
                            <div class="detail-items">
                                ...
                                <div class="detail-item">
                                    <label>Website:</label>
                                    <span>
                                        <a href="{{ $centre->centre_website }}" target="_blank" class="contact-link">
                            ...
                            <div class="operating-hours">
                                <div class="hours-display">
                                    <div class="hours-item">
                                        ...
                                        <span>Opens: {{ $centre->opening_time ? \Carbon\Carbon::parse($centre->opening_time)->format('g:i A') : 'Not specified' }}</span>
                                    </div>
                                    <div class="hours-item">
                                        <i class="fas fa-moon"></i>
                                        <span>Closes: {{ $centre->closing_time ? \Carbon\Carbon::parse($centre->closing_time)->format('g:i A') : 'Not specified' }}</span>
                                    </div>
                                </div>
                            ...
                            <div class="specialized-services">
                                ...
                                <div class="services-list">
                                    @foreach(json_decode($centre->specialized_services, true) ?? [] as $service)
                                        <span class="service-badge">{{ ucwords(str_replace('_', ' ', $service)) }}</span>
                                    @endforeach
                                </div>
                            </div>
                            @endif
            ...
            <div class="info-card">
                <div class="card-header">
                    ...
                    <a href="{{ route('activities.index') }}?centre={{ $centre->centre_id }}" class="view-all-link">View All</a>
                </div>
                <div class="card-content">
        ...
        <div class="right-column">
                    ...
                    <div class="analytics-grid">
                        <div class="metric-item">
                            ...
                            <div class="metric-content">
                                <div class="metric-value">{{ number_format(($stats->utilization_rate ?? 0), 1) }}%</div>
                        ...
                        <div class="metric-item">
                            ...
                            <div class="metric-content">
                                <div class="metric-value">{{ number_format(($stats->satisfaction_rate ?? 0), 1) }}</div>
            ...
            <div class="analytics-card">
                <div class="card-header">
                    ...
                    <a href="{{ route('centres.assets', $centre->centre_id) }}" class="view-all-link">Manage Assets</a>
                </div>
                <div class="card-content">
                                ...
                                <div class="asset-item">
                                    ...
                                    <div class="asset-info">
                                        ...
                                        <div class="asset-status">
                                            Status: <span class="status-{{ $asset->status ?? 'unknown' }}">{{ ucfirst($asset->status ?? 'Unknown') }}</span>
                                        </div>
                                    </div>
                    ...
                    @else
                        <div class="empty-state">
                            ...
                            @if(in_array(session('role'), ['admin', 'supervisor']))
                            <a href="{{ route('centres.assets', $centre->centre_id) }}" class="btn btn-primary btn-sm">
                                <i class="fas fa-plus"></i>
                                Add Assets
                            </a>
                            @endif
            ...
            <div class="quick-actions-card">
                ...
                <div class="card-content">
                    <div class="actions-grid">
                        ...
                        <a href="{{ route('activities.create') }}?centre={{ $centre->centre_id }}" class="action-item">
                            <div class="action-icon">
