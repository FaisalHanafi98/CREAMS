            ...
            <div class="stats-grid">
                ...
                <div class="stat-card stat-success">
                    ...
                    <div class="stat-content">
                        ...
                        <div class="stat-trend">
                            <i class="fas fa-arrow-up"></i>
                            <span>{{ number_format(($centres->where('centre_status', 'active')->count() / max($centres->count(), 1)) * 100, 1) }}% active</span>
                        </div>
                    </div>
                </div>
        ...
        <div class="search-container">
            <div class="search-input-group">
                ...
                <input type="text" 
                       id="centreSearch" 
                       class="search-input" 
                       placeholder="Search centres by name, location, manager, or facilities..."
                       autocomplete="off">
        ...
        <div id="gridView" class="centres-grid">
            @forelse($centres as $centre)
                <div class="centre-card" 
                     data-name="{{ strtolower($centre->centre_name) }}"
                        ...
                        <div class="card-actions">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    @if(in_array(session('role'), ['admin', 'supervisor']))
                                    <a class="dropdown-item" href="{{ route('centres.edit', $centre->centre_id) }}">
                                        <i class="fas fa-edit"></i> Edit Centre
                                    </a>
                                    @endif
                                    <a class="dropdown-item" href="{{ route('centres.assets', $centre->centre_id) }}">
                    ...
                    <div class="card-footer">
                        <div class="action-buttons">
                            <a href="{{ route('centres.show', $centre->centre_id) }}" class="btn btn-outline-primary btn-sm">
                                <i class="fas fa-eye"></i>
                                View
                            </a>
                            @if(in_array(session('role'), ['admin', 'supervisor']))
                            <a href="{{ route('centres.edit', $centre->centre_id) }}" class="btn btn-outline-warning btn-sm">
                                <i class="fas fa-edit"></i>
                                Edit
                            </a>
                            @endif
                            <a href="{{ route('centres.assets', $centre->centre_id) }}" class="btn btn-outline-info btn-sm">
                                <i class="fas fa-boxes"></i>
                                Assets
                            </a>
                        </div>
            ...
            @forelse($centres as $centre)
                <div class="list-item" 
                    ...
                    <div class="list-cell actions">
                        <a href="{{ route('centres.show', $centre->centre_id) }}" class="action-link" title="View Details">
                            <i class="fas fa-eye"></i>
                        </a>
                        @if(in_array(session('role'), ['admin', 'supervisor']))
                        <a href="{{ route('centres.edit', $centre->centre_id) }}" class="action-link" title="Edit Centre">
                            <i class="fas fa-edit"></i>
                        </a>
                        @endif
                        <a href="{{ route('centres.assets', $centre->centre_id) }}" class="action-link" title="Manage Assets">
                            <i class="fas fa-boxes"></i>
                        </a>
                    </div>
                </div>
