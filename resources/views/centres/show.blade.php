            ...
            <div class="col-lg-8">
                            ...
                            <div class="contact-details">
                                <div class="contact-item">
                                    ...
                                    <div class="contact-info">
                                        ...
                                        <span>{{ $centre->address }}, {{ $centre->city }}, {{ $centre->state }}
                                            {{ $centre->postcode }}</span>
                                    </div>
                                </div>
                                @if ($centre->phone)
                                    <div class="contact-item">
                        ...
                        <div class="detail-section">
                            ...
                            <div class="operating-hours">
                                <p><strong>Opening Time:</strong>
                                    {{ $centre->opening_time ? \Carbon\Carbon::parse($centre->opening_time)->format('g:i A') : 'Not specified' }}
                                </p>
                                <p><strong>Closing Time:</strong>
                                    {{ $centre->closing_time ? \Carbon\Carbon::parse($centre->closing_time)->format('g:i A') : 'Not specified' }}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="detail-card mt-4">
                    <div class="detail-card-header">
                        ...
                        <a href="{{ route('activities.home') }}?centre={{ $centre->centre_id }}"
                            ...
                            <div class="row">
                                <div class="col-md-4 text-center">
                                    <div class="asset-stat">
                                        <h4 class="text-primary">{{ $stats->total_assets ?? ($stats['total_assets'] ?? 0) }}
                                        </h4>
                                ...
                                <div class="col-md-4 text-center">
                                    <div class="asset-stat">
                                        <h4 class="text-success">{{ $stats->total_assets ?? ($stats['total_assets'] ?? 0) }}
                                        </h4>
                ...
                <div class="stats-card">
                    ...
                    <div class="stats-card-body">
                        ...
                        @if (isset($stats->utilization_rate) || isset($stats['utilization_rate']))
                            <div class="stat-item">
                                <div class="stat-value">{{ $stats->utilization_rate ?? ($stats['utilization_rate'] ?? 0) }}%
                                </div>
        ...
        function showControls() {
            ...
            if (modal.classList.contains('active')) {
                const controls = modal.querySelectorAll(
                    '.carousel-control-prev, .carousel-control-next, .carousel-indicators, .fullscreen-close');
