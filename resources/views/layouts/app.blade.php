            ...
            function renderNotifications(notifications, count) {
                ...
                if (notifications.length > 0) {
                    notifications.forEach(notification => {
                        ...
                        notificationsHtml += `
                            <a href="${actionUrl}" class="d-flex p-3 border-bottom notification-item" data-id="${notification.id}">
                                <div class="mr-3">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="smallest text-muted mt-1">${notification.time_ago}</div>
                                </div>
                            </a>
                        `;
                    });
            ...
            function updateNotificationCount(count) {
                ...
                if (count > 0) {
                    if (!notificationCountEl) {
                        ...
                        const bellIcon = document.querySelector('#notificationToggle .icon-button');
                        if (bellIcon) {
