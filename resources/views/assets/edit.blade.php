        ...
        <div class="row align-items-start g-3">
            <div class="col-lg-8">
                <div class="asset-breadcrumb">
                    ...
                    <i class="fas fa-chevron-right text-muted"></i>
                    <span class="asset-breadcrumb-current">Edit Asset</span>
                </div>
                ...
                <p class="asset-page-subtitle">
                    Update the asset details. Unchanged fields retain their current value.
                </p>
            </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select asset-input @error('category_id') is-invalid @enderror" id="category_id" name="category_id" required>
                                        ...
                                        @foreach($categories as $cat)
                                            <option value="{{ $cat->id }}" {{ old('category_id', $asset->category_id) == $cat->id ? 'selected' : '' }}>{{ $cat->category_name }}</option>
                                        @endforeach
                                    </select>
                                    @error('category_id')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control asset-input @error('manufacturer') is-invalid @enderror"
                                           id="manufacturer" name="manufacturer" value="{{ old('manufacturer', $asset->manufacturer) }}"
                                    ...
                                    <select class="form-select asset-input @error('centre_id') is-invalid @enderror" id="centre_id" name="centre_id" required>
                                        ...
                                        @foreach($centres as $centre)
                                            <option value="{{ $centre->centre_id }}"
                                                {{ old('centre_id', $asset->centre_id) == $centre->centre_id ? 'selected' : '' }}>
                                                {{ $centre->centre_name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row g-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="number" step="0.01" class="form-control asset-input @error('purchase_price') is-invalid @enderror"
                                           id="purchase_price" name="purchase_price" value="{{ old('purchase_price', $asset->purchase_price) }}"
                                           placeholder="0.00">
