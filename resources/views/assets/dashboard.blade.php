            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        ...
                        <p class="mb-0 opacity-90">Manage equipment, tools, and resources for {{ session('centre_name', 'your centre') }}</p>
                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if(($asset->status ?? 'available') === 'available')
                                        <button class="btn btn-success btn-action btn-sm" onclick="rentAsset('{{ $asset->id ?? '' }}')">
                                            <i class="fas fa-hand-paper mr-1"></i>Use
                                        </button>
                                    @elseif(($asset->status ?? 'available') === 'rented')
                                        <button class="btn btn-warning btn-action btn-sm" onclick="returnAsset('{{ $asset->id ?? '' }}')">
                                            <i class="fas fa-undo mr-1"></i>Return
                                        </button>
                                    @endif
                                    <button class="btn btn-primary btn-action btn-sm" onclick="editAsset('{{ $asset->id ?? '' }}')">
                                        <i class="fas fa-edit mr-1"></i>Edit
                                    </button>
                                    <button class="btn btn-danger btn-action btn-sm" onclick="deleteAsset('{{ $asset->id ?? '' }}')">
