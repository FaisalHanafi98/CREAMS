...
<style>
    ...
    /* Specific styling for centre location field */
    #centre_location {
                ...
                <div class="form-sections-container">
                    ...
                    <div class="form-section" id="section-2">
                        ...
                        <div class="form-group" style="margin-bottom: 35px;">
                            <label for="centre_location" style="font-size: 15px; font-weight: 600; margin-bottom: 12px; display: block;">Centre Location*</label>
                            <select class="form-control @error('centre_location') is-invalid @enderror" id="centre_location" name="centre_location" required style="font-size: 14px; min-height: 50px; padding: 15px 45px 15px 18px; line-height: 1.3;">
                                <option value="">-- Select a Centre --</option>
                                <option value="Gombak" {{ old('centre_location') === 'Gombak' ? 'selected' : '' }}>Gombak Campus</option>
                                <option value="Kuantan" {{ old('centre_location') === 'Kuantan' ? 'selected' : '' }}>Kuantan Campus</option>
                                <option value="Pagoh" {{ old('centre_location') === 'Pagoh' ? 'selected' : '' }}>Pagoh Campus</option>
                            </select>
                            <div class="form-help" style="margin-top: 8px; font-size: 13px;">Select the campus centre location where you will be working</div>
