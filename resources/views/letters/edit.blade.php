...
@section('title', 'Edit Letter - CREAMS')

@section('content')
<div class="letter-edit-container">
    ...
    <div class="form-container">
        <form action="{{ route('letters.update', $letter->id) }}" method="POST" class="letter-form">
            @csrf
            @method('PUT')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control @error('letter_date') is-invalid @enderror" 
                                               ...
                                               value="{{ old('letter_date', $letter->letter_date ? Carbon\Carbon::parse($letter->letter_date)->format('Y-m-d') : '') }}" required>
                                        @error('letter_date')
                                        ...
                                        <select class="form-control @error('template_id') is-invalid @enderror" 
                                            ...
                                            @foreach($templates as $template)
                                                <option value="{{ $template->id }}" 
                                                    {{ old('template_id', $letter->template_id) == $template->id ? 'selected' : '' }}>
                        ...
                        <div class="form-card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('recipient_address') is-invalid @enderror" 
                                          ...
                                          placeholder="Enter complete address including postal code" required>{{ old('recipient_address', $letter->recipient_address) }}</textarea>
                        ...
                        <div class="form-card-body">
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('body_content') is-invalid @enderror" 
                                          ...
                                          placeholder="Enter the main content of the letter..." required>{{ old('body_content', $letter->body_content) }}</textarea>
                                @error('body_content')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                ...
                <div class="col-lg-4">
                    ...
                    <div class="form-card">
                        ...
                        <div class="form-card-body">
                            ...
                            <a href="{{ route('letters.show', $letter->id) }}" class="btn btn-secondary btn-block">
                                <i class="fas fa-times mr-2"></i> Cancel
                            </a>
                            <hr>
                            <button type="button" class="btn btn-danger btn-block" data-toggle="modal" data-target="#deleteModal">
                                <i class="fas fa-trash-alt mr-2"></i> Delete Letter
                            </button>
                        </div>
                    </div>
                </div>
