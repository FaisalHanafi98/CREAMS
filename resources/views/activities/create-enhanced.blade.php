            ...
            <div class="form-step active" data-step="1">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group half-width">
                        ...
                        <div class="input-wrapper">
                            <input type="text" 
                                   id="activity_id" 
                                   name="activity_id" 
                                   class="form-control-enhanced auto-generated" 
                                   readonly
                    ...
                    <div class="form-group half-width">
                        ...
                        <div class="input-wrapper">
                            <select id="activity_type" name="activity_type" class="form-select-enhanced" required>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group full-width">
                        <label for="activity_location" class="form-label">
                            ...
                            Activity Location
                            <span class="required">*</span>
                            <span class="field-help" data-tooltip="Specific room or area where the activity will take place">?</span>
                        </label>
                        <div class="location-selection">
                            <div class="input-wrapper">
                                <select id="activity_location" name="activity_location" class="form-select-enhanced" required>
                                    <option value="">Select a location...</option>
                                    <!-- Options will be populated based on selected centre -->
                                </select>
                                <div class="select-indicator">
                                    <i class="fas fa-chevron-down"></i>
                                </div>
                            </div>
                            <button type="button" class="btn-add-location" id="addNewLocation">
                                <i class="fas fa-plus"></i>
                                Add New Location
                            </button>
                        </div>
                        <div class="validation-message"></div>
                        <div class="location-availability" id="locationAvailability" style="display: none;">
                            <!-- Dynamic availability check results -->
                        </div>
                    </div>
