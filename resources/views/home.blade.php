...
<section id="impact" class="section bg-primary text-white">
    <div class="container">
        ...
        {{-- New Centre Impact Placeholder --}}
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
                <div class="new-centre-notice p-5 rounded" style="background: rgba(255, 255, 255, 0.1); border: 2px dashed rgba(255, 255, 255, 0.3);">
                    <i class="fas fa-chart-line fa-4x mb-4" style="opacity: 0.7;"></i>
                    <h3 class="mb-3">New Centre - Impact Metrics Coming Soon</h3>
                    <p class="lead mb-4">As a newly established centre, we're actively working with our first cohort of children and families. Our impact metrics will be available as we gather meaningful data from our programs.</p>
                    ...
                    <p class="small mt-3" style="opacity: 0.8;">Check back soon to see our progress and achievements!</p>
                </div>
            </div>
        </div>
    </div>
