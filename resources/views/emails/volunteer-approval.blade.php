...
<body>
    ...
    <div class="content">
        ...
        <div class="next-steps">
            ...
            <ol>
                <li><strong>Orientation Session:</strong> You will be contacted within 3-5 business days to schedule your volunteer orientation.</li>
                <li><strong>Background Check:</strong> We may require a background verification as per our safety protocols.</li>
                <li><strong>Training Program:</strong> Attend mandatory volunteer training sessions specific to your role.</li>
                <li><strong>Assignment:</strong> Receive your specific volunteer role and schedule.</li>
        ...
        <div class="contact-info">
            ...
            <p><strong>Centre Contact:</strong> {{ $centreName }}</p>
        ...
        <ul>
            ...
            <li>Arrive punctually for all scheduled volunteer sessions</li>
