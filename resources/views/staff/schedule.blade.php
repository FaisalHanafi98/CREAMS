...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <div class="schedule-card">
                <h3 class="mb-4">
                    <i class="fas fa-calendar-day me-2 text-success"></i>Upcoming Sessions
                </h3>
                ...
                @foreach($sessions->take(10) as $session)
                    <div class="schedule-item mb-3">
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                <div class="activity-title">{{ $session->activity_name }}</div>
                            ...
                            <div class="text-end">
                                <span class="badge bg-info">{{ $session->enrolled_count }}/{{ $session->max_participants }}</span>
                                <br>
                ...
                @if(count($sessions) > 10)
                    <div class="text-center mt-3">
                        <small class="text-muted">Showing next 10 sessions of {{ count($sessions) }} total</small>
                    </div>
                @endif
            </div>
            @endif
