...
class DashboardController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            // Get today's sessions for schedule widget
            $todaysSessions = collect();
            try {
                $todaysSessions = \App\Models\ActivitySession::with(['activity', 'teacher', 'enrollments'])
                ...
                Log::error('Error fetching today\'s sessions for dashboard: ' . $e->getMessage());
            }
