...
class EnhancedMessage extends Model
{
    use HasFactory;
    ...
    {
        return $this->belongsTo(EnhancedMessage::class, 'parent_message_id');
    }
    ...
    {
        return $this->hasMany(EnhancedMessage::class, 'parent_message_id');
    }
        ...
        return $query->where(function($q) use ($userId) {
            $q->where('sender_id', $userId)
              ...
              ->orWhereHas('recipients', function($subQ) use ($userId) {
                  $subQ->where('recipient_type', 'App\\Models\\Users')
